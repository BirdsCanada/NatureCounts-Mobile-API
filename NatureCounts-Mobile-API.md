...
| customVars | JSON Array | No | JSON structure of type CUSTOM_JSON (see below) | Ex\|PC |
...
| customVars | JSON Array | No | Vector of custom variables, unique to the protocol. JSON structure of type CUSTOM_JSON (see above) | Ex\|PC |
...
| customVars | JSON Array | No | JSON structure of type CUSTOM_JSON (see above). | Ex\PC |
